import { CombinationBig } from "./combination"

describe('test CombinationBig', () => {
    test('6 pick or omit 1', () => {
        const a = 'abcdef'.split('')
        const comb = new CombinationBig(a.length, 1)
        let pickRet = []
        let omitRet = []
        for (let i of comb) {
    ...
    test('6 pick or omit 2', () => {
        const a = 'abcdef'.split('')
        const comb = new CombinationBig(a.length, 2)
        let pickRet = []
        let omitRet = []
        for (let i of comb) {
            pickRet.push(i.pickFrom(a))
    ...
    test('6 pick or omit 3', () => {
        const a = 'abcdef'.split('')
        const comb = new CombinationBig(a.length, 3)
        let pickRet = []
        let omitRet = []
        for (let i of comb) {
            pickRet.push(i.pickFrom(a))
    ...
    test('6 pick or omit 4', () => {
        const a = 'abcdef'.split('')
        const comb = new CombinationBig(a.length, 4)
        let pickRet = []
        let omitRet = []
        for (let i of comb) {
            pickRet.push(i.pickFrom(a))
    ...
    test('6 pick or omit 5', () => {
        const a = 'abcdef'.split('')
        const comb = new CombinationBig(a.length, 5)
        let pickRet = []
        let omitRet = []
        for (let i of comb) {
            pickRet.push(i.pickFrom(a))
    ...
    test('6 pick or omit 6', () => {
        const a = 'abcdef'.split('')
        const comb = new CombinationBig(a.length, 6)
        let pickRet = []
        let omitRet = []
        for (let i of comb) {
            pickRet.push(i.pickFrom(a))
    ...
    test('error pick or omit', () => {
        const a = 'abcdef'.split('')
        const comb = new CombinationBig(7, 2)
        for (let i of comb) {
